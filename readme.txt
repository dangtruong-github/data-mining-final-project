...
- Train + val: 3 files
+ train_no_freq.csv (2577 samples)
+ train_5_freq.csv (2577 samples)
+ train_10_freq.csv (2577 samples)
- Test: 1 file
+ test.csv (313 samples)
Cả 4 files đều có 10 cột, bao gồm cột id, cột text, và 8 cột ground truth label của 8 nhóm tag 

4. Slide trình bày - slides.pdf:
- Bao gồm 29 trang, đánh số từ 1-28 (trừ trang đầu tiên ra)